...
import carpet.mixins.EntityZombieVillagerMixin;
...
import carpet.mixins.EntityMixin;
import carpet.mixins.EntityItemMixin;
import carpet.mixins.EntityVillagerMixin;
import carpet.mixins.EntitySlimeMixin;
...
public class EntityInfo
{
    ...
    private static String display_item(ItemStack item)
    {
        ...
        if (item.isEnchanted())
        {
            ...
            for (Enchantment e: enchants.keySet())
            {
                ...
                //func_200305_d is "getDisplayName"
                stackname += enstring+" ";
            }
            stackname += ")";
        }
    ...
    public static List<ITextComponent> entityInfo(Entity e, World source_world)
    {
        ...
        if (source_world.dimension.getType() != e.dimension)
        {
            ...
            if (((EntityMixin)e).getfire() > 0) { lst.add(Messenger.c("w  - Fire for ","wb "+(((EntityMixin)e).getfire()),"w  ticks")); }
        ...
        if (e instanceof EntityItem)
        {
            ...
            lst.add(Messenger.c("w  - Despawn Timer: ", "wb "+makeTime(((EntityItemMixin)ei).getage())));
        }
        ...
        if (e instanceof EntityLivingBase)
        {
            ...
            if (e instanceof EntityLiving)
            {
                ...
                if (e instanceof EntityCreature)
                {
                    ...
                    if (e instanceof EntityAgeable)
                    {
                        ...
                        if (e instanceof EntityVillager)
                        {
                            ...
                            if (((EntityVillagerMixin)ev).getwealth()>0)
                            {
                                lst.add(Messenger.c("w  - Wealth: ", "lb "+((EntityVillagerMixin)ev).getwealth()+" emeralds" ));
                            }
                        }
                    ...
                    if (e instanceof EntityMob)
                    {
                        ...
                        if (e instanceof EntityZombieVillager)
                        {
                            ...
                            if (((EntityZombieVillagerMixin)ezv).getConversionTime() > 0)
                            {
                                lst.add(Messenger.c("w  - Convert to villager in: ","wb "+makeTime(((EntityZombieVillagerMixin)ezv).getConversionTime())));
                            }
                        }
                    }
                }
                ...
                {
                    lst.add(Messenger.c(String.format("w  - Base attack: %d",((EntitySlimeMixin)(EntitySlime)e).callgetAttackStrength())));
                }
            }
        }
